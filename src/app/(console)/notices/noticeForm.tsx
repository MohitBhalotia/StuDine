...
import { ChevronDownIcon, InfoIcon, Loader2, TrashIcon } from "lucide-react";
...
export function NoticeForm() {
  ...
  const handleSubmit = form.handleSubmit(async (data) => {
    try {
      ...
      await addNoticeToStore(noticeData);
    ...
    <Form {...form}>
      <form onSubmit={handleSubmit} className="flex flex-col w-full gap-6">
        ...
        <div className="flex items-center gap-4">
          <Label htmlFor="add-expiry-date">Add Expiry Date</Label>
          <Switch
            id="add-expiry-date"
            checked={addExpiryDate}
            onCheckedChange={setAddExpiryDate}
          />
        </div>
